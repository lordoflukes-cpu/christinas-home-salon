...
import { BookHeart, Home, Settings } from 'lucide-react';
...
export function LeoShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="leo-aurora relative mx-auto flex min-h-screen w-full max-w-md flex-col">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-20 mx-auto w-full max-w-md border-t border-cream-200 bg-cream-50/95 px-3 py-2 backdrop-blur">
